...
export class LoanApplicationService {
  ...
  getAll(): Observable<LoanApplicationResponse[]> {
    return this.http.get<BaseResponse<LoanApplicationResponse[]>>(
      `${this.endpoint}`,
      AUTHORIZED
    ).pipe(
  ...
  getForReview(id: string): Observable<LoanApplicationReviewResponse> {
    return this.http.get<BaseResponse<LoanApplicationReviewResponse>>(
  ...
  getForApproval(id: string): Observable<LoanApplicationApprovalResponse> {
    return this.http.get<BaseResponse<LoanApplicationApprovalResponse>>(
  ...
  getForDisbursement(id: string): Observable<LoanApplicationDisbursementResponse> {
    return this.http.get<BaseResponse<LoanApplicationDisbursementResponse>>(
  ...
  review(
    ...
    return this.http.post<BaseResponse<LoanApplicationResponse>>(
      `${this.endpoint}/${id}/review`,
      request,
      AUTHORIZED
    ).pipe(
