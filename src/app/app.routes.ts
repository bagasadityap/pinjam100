...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () => import('./features/loan-application/review/review').then((m) => m.Review),
  },
  {
  ...
  },
  {
    ...
    canActivate: [authGuard, roleGuard],
    data: { roles: ['SUPER_ADMIN'] },
    loadComponent: () => import('./features/customer/all/customer').then((m) => m.Customer),
  },
  {
    ...
    loadComponent: () =>
      import('./features/customer/all/customer-detail/customer-detail').then(
        (m) => m.CustomerDetail,
      ),
  },
  {
  ...
  },
  {
    ...
    data: { roles: ['SUPER_ADMIN', 'DOCUMENT_CHECKER'] },
    loadComponent: () =>
      import('./features/customer/verify-customer/customer-detail/customer-detail').then(
        (m) => m.CustomerDetail,
      ),
  },
  {
  ...
  },
  {
    ...
    canActivate: [authGuard, roleGuard],
    data: { roles: ['SUPER_ADMIN', 'CREDIT_ANALYST'] },
    loadComponent: () => import('./features/limit-setting/setting/setting').then((m) => m.Setting),
  },
  {
    path: 'roles-permissions',
    canActivate: [authGuard, roleGuard],
    data: { roles: ['SUPER_ADMIN'] },
    loadComponent: () => import('./features/role-permission/role').then((m) => m.RolePermission),
  },
  {
    path: 'branch',
    canActivate: [authGuard, roleGuard],
    data: { roles: ['SUPER_ADMIN'] },
    loadComponent: () => import('./features/branch/branch').then((m) => m.Branch),
  },
  {
    path: 'forbidden',
    loadComponent: () => import('./features/error/forbidden/forbidden').then((m) => m.Forbidden),
  },
  {
    path: '**',
